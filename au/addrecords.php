...
<div class="row m-t-10">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title">Add New Business Record</h4>
                <form action="handlers/addrecord.php" method="POST">
                    <div class="row">
                        <div class="col-xl-12">
                            <!-- Form Fields -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <input class="form-control" type="text" id="lead_source" name="lead_source" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="decision_maker_name" class="col-sm-4 col-form-label">Decision Maker Name</label>
                                <div class="col-sm-12">
                                    <input class="form-control" type="text" id="decision_maker_name" name="decision_maker_name" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="decision_maker_position" class="col-sm-4 col-form-label">Decision Maker Position</label>
                                <div class="col-sm-12">
                                    <input class="form-control" type="text" id="decision_maker_position" name="decision_maker_position" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="ecommerce_platform" class="col-sm-4 col-form-label">E-commerce Platform</label>
                                <div class="col-sm-12">
                                    <input class="form-control" type="text" id="ecommerce_platform" name="ecommerce_platform" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="main_product_category" class="col-sm-4 col-form-label">Store Main Product Category</label>
                                <div class="col-sm-12">
                                    <input class="form-control" type="text" id="main_product_category" name="main_product_category" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="monthly_revenue" class="col-sm-4 col-form-label">Monthly Online Revenue</label>
                                <div class="col-sm-12">
                                    <input class="form-control" type="number" id="monthly_revenue" name="monthly_revenue" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="first_contact_date" class="col-sm-4 col-form-label">Date of First Contact</label>
                                <div class="col-sm-12">
                                    <input class="form-control" type="datetime-local" id="first_contact_date" name="first_contact_date" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="services_interested_in" class="col-sm-4 col-form-label">Services Interested In</label>
                                <div class="col-sm-12">
                                    <input class="form-control" type="text" id="services_interested_in" name="services_interested_in" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="current_marketing_channels" class="col-sm-4 col-form-label">Current Marketing Channels</label>
                                <div class="col-sm-12">
                                    <input class="form-control" type="text" id="current_marketing_channels" name="current_marketing_channels" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="estimated_budget" class="col-sm-4 col-form-label">Estimated Budget</label>
                                <div class="col-sm-12">
                                    <input class="form-control" type="number" id="estimated_budget" name="estimated_budget" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="proposal_sent_date" class="col-sm-4 col-form-label">Proposal Sent Date</label>
                                <div class="col-sm-12">
                                    <input class="form-control" type="datetime-local" id="proposal_sent_date" name="proposal_sent_date" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="proposal_value" class="col-sm-4 col-form-label">Proposal Value</label>
                                <div class="col-sm-12">
                                    <input class="form-control" type="number" id="proposal_value" name="proposal_value" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="contract_sign_date" class="col-sm-4 col-form-label">Contract Sign Date</label>
                                <div class="col-sm-12">
                                    <input class="form-control" type="datetime-local" id="contract_sign_date" name="contract_sign_date">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="contract_value" class="col-sm-4 col-form-label">Contract Value</label>
                                <div class="col-sm-12">
                                    <input class="form-control" type="number" id="contract_value" name="contract_value">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="last_contact_date" class="col-sm-4 col-form-label">Last Contact Date</label>
                                <div class="col-sm-12">
                                    <input class="form-control" type="datetime-local" id="last_contact_date" name="last_contact_date">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="next_scheduled_action" class="col-sm-4 col-form-label">Next Scheduled Action</label>
                                <div class="col-sm-12">
                                    <input class="form-control" type="datetime-local" id="next_scheduled_action" name="next_scheduled_action" required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <input class="form-control" type="number" id="follow_ups" name="follow_ups" required>
                                </div>
                            </div>
                            <!-- Submit Button -->
                            <div class="form-group row">
